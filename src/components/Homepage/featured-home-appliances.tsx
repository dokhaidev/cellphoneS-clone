...
import { homeApplianceBrands, sampleHomeAppliances } from "@/src/data/sampleHomeAppliances";
...
export default function FeaturedAudio() {
  ...
  const filteredProducts: Product[] =
    selectedBrand === "Xem tất cả"
      ? sampleHomeAppliances
      : sampleHomeAppliances.filter((product) => product.brand === selectedBrand);
